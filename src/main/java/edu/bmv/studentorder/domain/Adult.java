...
public class Adult extends Person {
    ...
    public Adult(String surName, String givenName, String patronymicName, LocalDate dateOfBirth) {
        super(surName, givenName, patronymicName, dateOfBirth);
    }


    public String getPerson(){
        return  getSurName() + " " + getGivenName() + " " + getPatronymicName() + " : " +passportNumber;
