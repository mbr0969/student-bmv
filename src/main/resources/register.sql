SELECT ap.temporal  FROM cr_address_person AS ap
 ...
 AND UPPER(p.sur_name) = UPPER('Васильев') AND UPPER(p.given_name) =UPPER('Павел') AND UPPER(p.patronymic) = UPPER('Николаевич') AND p.date_of_birth = '1995-03-18'
